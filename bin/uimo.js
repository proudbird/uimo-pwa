...
commander_1.program
    ...
    .action(function (path, options, command) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, run_1.run)(options)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
...
commander_1.program.command('list')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, run_1.listInstancies)()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
